  ...
  return (
    <section id="contact" className="section-pad" style={{ background: 'var(--color-bg-primary)' }}>
      <div className="container-x">
        ...
        {/* Full-width map below contact columns */}
        <div className="mt-10 overflow-hidden" style={{ height: '340px' }}>
          <iframe
            title="Hi-Tech Doors location — 6 7th Avenue Newton Park Port Elizabeth"
            src="https://maps.google.com/maps?q=HI-TECH+DOORS,+6+7th+Avenue,+Newton+Park,+Port+Elizabeth&output=embed&z=17"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
